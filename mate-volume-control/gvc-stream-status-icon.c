...
/*HACK set up theme and transparency support*/
#if GTK_CHECK_VERSION (3, 0, 0) 
...
gvc_stream_status_icon_init (GvcStreamStatusIcon *icon)
{
        ...
        gvc_channel_bar_set_orientation (GVC_CHANNEL_BAR (icon->priv->bar),
       	...
       	/* HACK-set volume control frame, slider and toplevel window to follow panel theme */
  ...
  /*HACK*/  /* Make transparency possible in gtk3 theme */   
